                ...
                <div className="mt-16 pt-8 border-t border-bone-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
                    <div className="flex gap-6">
                        <p className="text-bone-white/40 text-sm font-inter">
                            © {currentYear} Miracle Okeke · UI/UX Designer & Frontend Developer
                        </p>
                    </div>
                    <div className="flex gap-6 items-center">
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-bone-white/40 hover:text-[#ff3c00] transition-colors"
                            aria-label="GitHub"
                        >
                        ...
                        <a
                            href="/privacy"
                            className="text-bone-white/40 text-sm font-inter hover:text-[#ff3c00] transition-colors"
                        >
                            Privacy
                        </a>
                    </div>
