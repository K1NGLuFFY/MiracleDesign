...
/**
 * Contact Form Component - Formspree Integration
 * 
 * Submits directly to Formspree for email delivery.
 * Configure redirect URL in Formspree dashboard settings.
 * 
...
export default function ContactForm() {
    ...
    return (
        <section id="contact" className="py-32 px-6 md:px-12 bg-[#0a0a0a] border-t border-white/10">
            ...
            <form
                action="https://formspree.io/f/mykjjwok"
                method="POST"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <input
                            ...
                            className="bg-transparent border-b border-white/20 py-4 text-[#f4f4f0] 
                                transition-colors
